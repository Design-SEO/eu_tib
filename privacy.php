            ...
            <div class="row">
              <div class="col-12 features-row text-justify">
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__responsibilities_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__controller_intro') ?><br />
                  <br />
                  <span class="text-warning">
                    <?php echo getLang('privacy__security_warning') ?>
                  </span>
                  <br />
                  <br />
                  <?php echo getLang('privacy__user_responsibilities_label') ?><br />
                  <?php echo getLang('privacy__user_responsibility_1') ?>
                  <br />
                  <?php echo getLang('privacy__user_responsibility_2') ?><br />
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__collected_info_title') ?>
                </h1>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__ip_address_title') ?>
                </h2>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__ip_address_text') ?>
                </p>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                ...
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__shared_info_title') ?>
                </h1>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__email_links_title') ?>
                </h2>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__email_links_text_1') ?><br />
                  <br />
                  <?php echo getLang('privacy__email_links_text_2') ?>
                </p>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__reg_form_title') ?>
                </h2>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__reg_form_text') ?>
                </p>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__contact_form_title') ?>
                </h2>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__contact_form_text') ?>
                </p>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__newsletter_title') ?>
                </h2>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__newsletter_text') ?>
                </p>
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__support_title') ?>
                </h2>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__support_text') ?>
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__data_usage_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__data_usage_intro') ?>
                </p>
                <ul class="list">
                  <li><?php echo getLang('privacy__data_usage_list_1') ?></li>
                  <li>
                    <?php echo getLang('privacy__data_usage_list_2') ?>
                  </li>
                  <li><?php echo getLang('privacy__data_usage_list_3') ?></li>
                  <li>
                    <?php echo getLang('privacy__data_usage_list_4') ?>
                  </li>
                </ul>
                <br />
                <h2 class="text-primary font-weight-bold text-6 text-uppercase mb-0">
                  <?php echo getLang('privacy__marketing_title') ?>
                </h2>
                <ul class="list">
                  <li>
                    <?php echo getLang('privacy__marketing_list_1') ?>
                  </li>
                  <li>
                    <?php echo getLang('privacy__marketing_list_2') ?>
                  </li>
                </ul>
                
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__external_links_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__external_links_text') ?>
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__sharing_info_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__sharing_info_text') ?>
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__security_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__security_text') ?>
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__storage_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__storage_text') ?>
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__erasure_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__erasure_text') ?>
                </p>
                <h1 class="text-primary font-weight-bold text-10 text-uppercase mb-0">
                  <?php echo getLang('privacy__rectification_title') ?>
                </h1>
                <p class="text-justify p-2">
                  <?php echo getLang('privacy__rectification_text') ?>
                </p>
                <a href="<?php echo getHref('login') ?>"><?php echo getLang('privacy__footer_email') ?></a><br />
              </div>
            </div>
          </div>
        </section>
