                    ...
                    <div class="header-nav-main header-nav-main-square header-nav-main-effect-1 header-nav-main-sub-effect-1">
                      <nav class="collapse">
                        <ul class="nav nav-pills" id="mainNav">
                          ...
                          <li class="dropdown">
                            <a class="dropdown-item mx-1 active" href="<?php echo getHref('login') ?>">
              ...
              <div class="col-lg-6">
                <div class="">
                  <h2 class="font-weight-bold text-10 mt-1 mb-0 text-uppercase">
                    <?php echo getLang('login__subtitle'); ?>
                  </h2>

                  <div class="tabs tabs-bottom tabs-center tabs-simple mt-5">
              ...
              <div class="col-lg-6">
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="400">
                  <div class="owl-carousel owl-theme dots-inside mb-0 pb-0"
                    ...
                    <div class="pb-5">
                      <img alt="" class="img-fluid rounded" src="/assets/images/generic-corporate-3-2-full.webp" />
                    </div>
                    <div class="pb-5">
                      <img alt="" class="img-fluid rounded" src="/assets/images/generic-corporate-3-3-full.webp" />
                    </div>
                  </div>
                </div>
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800" data-plugin-options="{'accY': -200}">
                  <h4 class="text-7 text-uppercase">
                    <?php echo getLang('office_section_title'); ?>
                    <strong class="text-primary"><?php echo getLang('office_section_title'); ?></strong>
                  </h4>
                  <ul class="list list-icons list-icons-style-3 mt-2">
                    <li>
                      <i class="fas fa-map-marker-alt top-6"></i>
                      <?php echo getLang('office_address'); ?>
                    </li>
                    <li>
                      <i class="fas fa-envelope top-6"></i>
                      <strong><?php echo getLang('office_email_label'); ?></strong>
                      <a href="<?php echo getHref('login') ?>"><?php echo getLang('office_email'); ?></a>
                    </li>
                  </ul>
                </div>

                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1000" data-plugin-options="{'accY': -200}">
                  <h4 class="pt-4 text-7 text-uppercase">
                    <?php echo getLang('business_hours_title'); ?>
                  </h4>
                  <ul class="list list-icons list-icons-style-3 mt-2">
                    <li>
                      ...
                      <br />
                      <?php echo getLang('business_hours'); ?>
                    </li>
                  </ul>
                </div>
              </div>
