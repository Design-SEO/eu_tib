...
<html lang="<?php echo getLang('locale_lang') ?>">
  ...
  <body class="dark" data-plugin-page-transition="">
    ...
    <div class="body">
                    ...
                    <div class="header-nav-main header-nav-main-square header-nav-main-effect-1 header-nav-main-sub-effect-1">
                      <nav class="collapse">
                        <ul class="nav nav-pills" id="mainNav">
                          ...
                          <li class="dropdown">
                            <a class="dropdown-item mx-1 active" href="<?php echo getHref('about') ?>">
      ...
      <div role="main" class="main">
        <div class="container pb-1">
            ...
            <div class="col">
              <div class="overflow-hidden mb-3">
                <h2 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
                  <?php echo getLang('way_to_title'); ?>
                  <span class="word-rotator-words bg-primary">
                    <b class="is-visible"><?php echo getLang('way_to_subtitle_1'); ?></b>
                    <b><?php echo getLang('way_to_subtitle_2'); ?></b>
                    <b><?php echo getLang('way_to_subtitle_3'); ?></b>
                  </span>
                </h2>
              </div>
            </div>
          ...
          <div class="row mb-2">
            <div class="col-lg-10 mb-2 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="450">
              <div class="overflow-hidden">
                <p class="lead mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="250">
                  <?php echo getLang('careers_section_text'); ?>
                </p>
              </div>
            </div>
            <div class="col-lg-2 mb-2 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="450">
              <a href="<?php echo getHref('login') ?>" class="btn btn-modern btn-outline-success"><?php echo getLang('careers_section_title'); ?></a>
            </div>
          </div>
        </div>
            ...
            <div class="row align-items-center">
              <div class="col-md-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1000">
                <div class="owl-carousel owl-theme nav-inside mb-0" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 6000, 'loop': true}">
                  <div>
                    <img alt="" class="img-fluid" src="/assets/images/generic-corporate-3-2-full.webp" />
                  </div>
                  <div>
                    <img alt="" class="img-fluid" src="/assets/images/generic-corporate-3-3-full.webp" />
                  </div>
                </div>
              </div>
              <div class="col-md-6 px-5">
                <div class="appear-animation" data-appear-animation="fadeInDownShorter">
                  <img class="image-fluid hvr-bob" src="/assets/images/logo.webp" alt="CapitureX sàrl" width="320" />
                </div>
                <h2 class="font-weight-normal text-6">
                  <strong class="font-weight-extra-bold"><?php echo getLang('about__who_we_are_title'); ?></strong>
                </h2>
                <p class="text-justify">
                  <?php echo getLang('about__who_we_are_text_1'); ?>
                </p>
                <p class="text-justify">
                  <?php echo getLang('about__who_we_are_text_2'); ?>
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="row features-row">
              <div class="col-xs-12 col-md-12">
                <div class="appear-animation" data-appear-animation="fadeInUpShorter">
                  <h3 class="text-center title-head text-color-light font-weight-bold text-12">
                    <?php echo getLang('about_gateway_title'); ?>
                  </h3>
                  <br />
                </div>
                <div class="row">
                  <div class="col-md-4 text-justify">
                    <img src="/assets/images/atms.webp" class="img-responsive hvr-bob" />
                    <br />
                  </div>
                  <div class="col-md-8 text-justify hvr-grow pt-5 pb-5">
                    <div class="appear-animation" data-appear-animation="fadeInDownShorter">
                      <p><?php echo getLang('about_gateway_text'); ?></p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section class="section p-5" id="arif">
          <div class="appear-animation" data-appear-animation="fadeInUpShorter">
            <h3 class="title-head text-primary font-weight-bold text-8 mt-3 mb-2">
              <?php echo getLang('arif_section_title'); ?>
            </h3>
          </div>
          <div class="appear-animation" data-appear-animation="fadeInUpShorter">
            <p class="text-justify text-4">
              <?php echo getLang('arif_section_text'); ?>
            </p>
            <a href="<?php echo getHref('login') ?>"><?php echo getLang('arif_section_btn'); ?>
        ...
        <section class="text-center mb-0">
          <div class="appear-animation" data-appear-animation="fadeInLeftShorter">
            <h2 class="word-rotator font-weight-semi-bold letters rotate-3 mb-2 pt-5">
              <span><?php echo getLang('buy_sell_cryptos_title_1'); ?></span>
              <span class="word-rotator-words bg-primary">
                <b>Bitcoin</b>
                <b class="is-visible">Ethereum</b>
                <b>Litecoin</b>
                <b>Monero</b>
                <b>Cardano</b>
                <b>Polkadot</b>
              ...
              <span><?php echo getLang('buy_sell_cryptos_title_2'); ?></span>
              <span><?php echo getLang('buy_sell_cryptos_text'); ?></span>
            </h2>
          </div>
        </section>
          ...
          <div class="appear-animation" data-appear-animation="fadeInDownShorterPlus">
            <div class="row">
              <div class="col-lg-12 mb-0">
                <h2 class="word-rotator font-weight-semi-bold letters rotate-3 mb-2 pt-5 text-justify">
                  <span><?php echo getLang('pre_sell_cryptos_title_1'); ?></span>
                  <span class="word-rotator-words bg-primary">
                    <b>Bitcoin</b>
                    <b class="is-visible">Ethereum</b>
                    <b>Litecoin</b>
                  ...
                  <span><?php echo getLang('pre_sell_cryptos_title_2'); ?></span>
                  <span><?php echo getLang('pre_sell_cryptos_text'); ?></span>
                </h2>
              </div>
            </div>
          </div>
        ...
        <div class="container" id="partners">
          <div class="row py-5 my-5">
            <div class="col">
              ...
              <!-- Partners carousel and images here -->
              <div class="text-start appear-animation" data-appear-animation="fadeInLeftShorter">
                <h2 class="text-success text-uppercase pt-5 mb-1">
                  <?php echo getLang('partners_section_subtitle'); ?>
                </h2>
                <p class="text-justify">
                  <?php echo getLang('partners_section_text'); ?>
                </p>
                <a href="<?php echo getHref('login') ?>" class="btn btn-outline-success btn-modern"><?php echo getLang('partners_read_more_btn'); ?></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="/assets/js/word-rotator.js"></script>
  </body>
